#Create Station
execute at @e[type=item,nbt={Item:{id:"minecraft:hopper",Count:1b}},limit=1] run execute if entity @e[type=xp_orb,distance=0..2] if block ~ ~ ~ cauldron[level=0] align xyz unless entity @e[tag=xp_table,tag=locator,dx=0,dy=1,dz=0,limit=1,sort=nearest] run scoreboard players set @e[limit=1,sort=nearest] table 1
execute at @e[type=item,nbt={Item:{id:"minecraft:hopper",Count:1b}},limit=1,scores={table=1}] run kill @e[type=xp_orb,distance=0..2]
...
execute at @a[advancements={s250pack:magic/xp_collect=false}] if score @p id_least = @e[tag=locator,tag=xp_table,limit=1,sort=nearest,scores={age=1},distance=0..4] id_least if score @p id_most = @e[tag=locator,tag=xp_table,limit=1,sort=nearest,scores={age=1},distance=0..4] id_most run playsound minecraft:ui.toast.challenge_complete player @p ~ ~ ~ 1 1.5
execute at @a if score @p id_least = @e[tag=locator,tag=xp_table,limit=1,sort=nearest,scores={age=1},distance=0..4] id_least if score @p id_most = @e[tag=locator,tag=xp_table,limit=1,sort=nearest,scores={age=1},distance=0..4] id_most run advancement grant @p until s250pack:magic/xp_collect
...
execute at @e[type=xp_orb] run execute store result score @e[type=xp_orb,limit=1,sort=nearest] xp run data get entity @e[type=xp_orb,limit=1,sort=nearest] Value
...
#Behavior: XP Collection
execute at @e[tag=locator,tag=xp_table,scores={xp=..199}] run execute as @e[type=xp_orb,distance=0..5] at @s run teleport @s ^ ^ ^0.02 facing entity @e[tag=locator,tag=xp_table,limit=1,sort=nearest,distance=0..5]
execute at @e[tag=locator,tag=xp_table,scores={xp=..199}] run execute as @e[type=xp_orb,distance=1.5..5] at @s run data merge entity @s {Motion:[0.0,0.03,0.0]}
execute as @e[tag=locator,tag=xp_table,scores={xp=..199}] at @s positioned ~ ~-1 ~ if entity @e[type=xp_orb,dx=0,dy=1,dz=0,limit=1,sort=nearest] run scoreboard players operation @s xp += @e[type=xp_orb,dx=0,dy=1,dz=0,limit=1,sort=nearest] xp
execute as @e[tag=locator,tag=xp_table,scores={xp=..199}] at @s positioned ~ ~-1 ~ if entity @e[type=xp_orb,dx=0,dy=1,dz=0,limit=1,sort=nearest] run particle minecraft:happy_villager ~ ~1 ~ 1 0.5 1 1 1
execute at @e[tag=locator,tag=xp_table,scores={xp=..199}] positioned ~ ~-1 ~ if entity @e[type=xp_orb,dx=0,dy=1,dz=0,limit=1,sort=nearest] run kill @e[type=xp_orb,dx=0,dy=1,dz=0,limit=1,sort=nearest]
...
scoreboard players set @e[tag=locator,tag=xp_table,scores={xp=50..149}] animation 2
scoreboard players set @e[tag=locator,tag=xp_table,scores={xp=150..199}] animation 3
scoreboard players set @e[tag=locator,tag=xp_table,scores={xp=200..}] animation 4
execute at @e[tag=locator,tag=xp_table,scores={animation=0}] run data merge entity @e[tag=model,tag=xp_table,tag=a,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:glass_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=1..}] run data merge entity @e[tag=model,tag=xp_table,tag=a,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:experience_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=..1}] run data merge entity @e[tag=model,tag=xp_table,tag=b,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:glass_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=2..}] run data merge entity @e[tag=model,tag=xp_table,tag=b,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:experience_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=..2}] run data merge entity @e[tag=model,tag=xp_table,tag=c,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:glass_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=3..}] run data merge entity @e[tag=model,tag=xp_table,tag=c,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:experience_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=..3}] run data merge entity @e[tag=model,tag=xp_table,tag=d,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:glass_bottle}]}
execute at @e[tag=locator,tag=xp_table,scores={animation=4..}] run data merge entity @e[tag=model,tag=xp_table,tag=d,tag=model,limit=1,sort=nearest] {ArmorItems:[{},{},{},{Count:1,id:experience_bottle}]}
...
execute at @e[tag=locator,tag=xp_table,scores={animation=1}] positioned ~ ~-2 ~ run execute as @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=1},limit=1,sort=nearest] positioned ~ ~-1.58 ~ run teleport @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.00 ~0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=1}] positioned ~ ~-2 ~ run execute as @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=1},limit=1,sort=nearest] positioned ~ ~-1.58 ~ run teleport @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.00 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=1}] positioned ~ ~-2 ~ run execute as @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=1},limit=1,sort=nearest] positioned ~ ~-1.58 ~ run teleport @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.01 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=1}] positioned ~ ~-2 ~ run execute as @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=1},limit=1,sort=nearest] positioned ~ ~-1.58 ~ run teleport @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.005 ~0.1

execute at @e[tag=locator,tag=xp_table,scores={animation=2}] positioned ~ ~-2 ~ run execute as @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=2},limit=1,sort=nearest] positioned ~ ~-1.38 ~ run teleport @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.00 ~0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=2}] positioned ~ ~-2 ~ run execute as @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=2},limit=1,sort=nearest] positioned ~ ~-1.38 ~ run teleport @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.00 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=2}] positioned ~ ~-2 ~ run execute as @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=2},limit=1,sort=nearest] positioned ~ ~-1.38 ~ run teleport @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.01 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=2}] positioned ~ ~-2 ~ run execute as @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=2},limit=1,sort=nearest] positioned ~ ~-1.38 ~ run teleport @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.005 ~0.1

execute at @e[tag=locator,tag=xp_table,scores={animation=3}] positioned ~ ~-1 ~ run execute as @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=3},limit=1,sort=nearest] positioned ~ ~-1.18 ~ run teleport @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.00 ~0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=3}] positioned ~ ~-1 ~ run execute as @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=3},limit=1,sort=nearest] positioned ~ ~-1.18 ~ run teleport @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.00 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=3}] positioned ~ ~-1 ~ run execute as @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=3},limit=1,sort=nearest] positioned ~ ~-1.18 ~ run teleport @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.01 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=3}] positioned ~ ~-1 ~ run execute as @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=3},limit=1,sort=nearest] positioned ~ ~-1.18 ~ run teleport @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.005 ~0.1

execute at @e[tag=locator,tag=xp_table,scores={animation=4}] positioned ~ ~-1 ~ run execute as @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=4},limit=1,sort=nearest] positioned ~ ~-0.98 ~ run teleport @e[tag=a,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.00 ~0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=4}] positioned ~ ~-1 ~ run execute as @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=4},limit=1,sort=nearest] positioned ~ ~-0.98 ~ run teleport @e[tag=b,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.00 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=4}] positioned ~ ~-1 ~ run execute as @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=4},limit=1,sort=nearest] positioned ~ ~-0.98 ~ run teleport @e[tag=c,tag=fill,tag=xp_table,limit=1,sort=nearest] ~0.1 ~0.01 ~-0.1
execute at @e[tag=locator,tag=xp_table,scores={animation=4}] positioned ~ ~-1 ~ run execute as @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest,distance=0..1] positioned as @e[tag=locator,tag=xp_table,scores={animation=4},limit=1,sort=nearest] positioned ~ ~-0.98 ~ run teleport @e[tag=d,tag=fill,tag=xp_table,limit=1,sort=nearest] ~-0.1 ~0.005 ~0.1
...
execute as @e[tag=locator,tag=xp_table,scores={click=2}] at @s run scoreboard players remove @s xp 100
