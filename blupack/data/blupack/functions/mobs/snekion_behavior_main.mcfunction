...
execute as @e[tag=snekion,tag=execute_flame_1] at @s positioned ^ ^ ^1 facing entity @p eyes run function blupack:spells/fire/flame_spell_p1 
...
execute as @e[tag=snekion,tag=execute_meteor_2] at @s positioned ^ ^ ^1 facing entity @p eyes run function blupack:spells/fire/meteor_spell_p2
...
execute as @a[advancements={blupack:magic/nether_hard/snekion_encounter=false}] at @s if entity @e[tag=meteor,tag=meteor_proj,tag=hostile,distance=0..2] run tag @s add SNEKION_ENCOUNTER
execute as @e[tag=meteor,tag=meteor_proj,tag=hostile] at @s unless entity @a[distance=0..4] run execute as @a[tag=SNEKION_ENCOUNTER,advancements={blupack:magic/nether_hard/snekion_encounter=false}] at @s run playsound minecraft:ui.toast.challenge_complete player @s ~ ~ ~ 1 1.5
execute as @e[tag=meteor,tag=meteor_proj,tag=hostile] at @s unless entity @a[distance=0..4] run advancement grant @a[tag=SNEKION_ENCOUNTER,advancements={blupack:magic/nether_hard/snekion_encounter=false}] until blupack:magic/nether_hard/snekion_encounter
...
advancement grant @a[advancements={blupack:magic/nether_hard/scroll_find=false},nbt={Inventory:[{tag:{scroll:"blank"}}]}] until blupack:magic/nether_hard/scroll_find
